...
$comments=chen_fetch_all("select * from comments where status='approved'
    order by created desc limit 1,30;")
?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
  ...
  <div class="wrapper">
    <div class="topnav">
      <ul>
        ...
        <li><a href="javascript:;"><i class="fa fa-glass"></i><?php echo $item['name']; ?></a></li>
        <?php endforeach ?>
        ...
        <?php foreach($comments as $item): ?>
          <li>
            <a href="javascript:;">
              ...
              <div class="txt">
                <p>
                  <span><?php echo $item['author']; ?></span><?php echo $item['created']; ?>
                </p>
